...
STOCKS = {
    ...
    'MOPH.CA':'ممفيس للأدوية','CPCI.CA':'القاهرة للأدوية','NIPH.CA':'النيل للأدوية',
    'AXPH.CA':'الإسكندرية للأدوية','PHAR.CA':'العربية للأدوية','ZMID.CA':'زهراء المعادي',
    'ELSH.CA':'الشمس للإسكان','ARAB.CA':'عربية أصول','PRDC.CA':'بايونيرز بروبرتيز',
    'UNIT.CA':'المتحدة للإسكان','ACGC.CA':'العربية لإدارة الأصول','AREH.CA':'المصرية العقارية',
    'AJWA.CA':'اجواء','CCTC.CA':'القاهرة للزيوت','ZEOT.CA':'الزيوت المستخلصة',
    'ISSC.CA':'الشرقية الوطنية','MFTG.CA':'مطاحن شمال القاهرة','MIME.CA':'مطاحن مصر الوسطى',
    'EGYP.CA':'المصرية للنقل','SPIN.CA':'الإسكندرية للغزل'
}
